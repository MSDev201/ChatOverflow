...
namespace ChatOverflow.Migrations
{
    ...
    [Migration("20190928184014_ChangedSomeGroupChatFieldsWithAccess")]
    partial class ChangedSomeGroupChatFieldsWithAccess
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatOverflow.Models.DB.UserModels.UserSpecificToken", b =>
                {
                    b.HasOne("ChatOverflow.Models.DB.UserModels.User", "User")
                        .WithMany("Tokens")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ChatOverflow.Models.DB.UserModels.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
